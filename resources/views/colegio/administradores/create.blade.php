                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="cargo" id="cargo" value="{{ old('cargo', 'Administrador General') }}" 
                                ...
                                <div>
                                    ...
                                    <input type="text" name="telefono_admin" id="telefono_admin" value="{{ old('telefono_admin') }}" 
